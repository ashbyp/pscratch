...
def part2(data: str, debug: bool = False):
    ...
    while instructions:
        ...
        if 'NOT' in ins:
            ...
            p1 = p(1, params, ins)
            if p1 is not None:
                vals[params[3]] = p1 ^ 0xFFFF
            else:
                instructions.insert(0, ins)
        elif 'RSHIFT' in ins:
            # ['y', 'RSHIFT', '2', '->', 'g']
            p0, p2 = p(0, params, ins), p(2, params, ins)
