...
tdata = """R75,D30,R83,U83,L12,D49,R71,U7,L72
U62,R66,U55,R34,D71,R55,D58,R83"""

tdata1="""R8,U5,L5,D3
U7,R6,D4,L4"""

tdata2 = """R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51
U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"""

tdata3="""R75,D30,R83,U83,L12,D49,R71,U7,L72
U62,R66,U55,R34,D71,R55,D58,R83"""

tdata4="""R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51
U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"""
...
def part2():
    ...
    for ins in wire1.split(','):
        ...
        for _ in range(m):
            ...
            col = col + DIRS[d][1]
            steps = steps + 1
            if (row, col) not in wire1_pts:
                wire1_pts[(row, col)] = steps
    wire2_pts = {}
    row, col = 0, 0
    steps = 0
    for ins in wire2.split(','):
        d = ins[0]
        m = int(ins[1:])
        for _ in range(m):
            row = row + DIRS[d][0]
            col = col + DIRS[d][1]
            steps = steps + 1
            if (row, col) not in wire2_pts:
                wire2_pts[(row, col)] = steps

    common = set(wire1_pts.keys()).intersection(set(wire2_pts.keys()))
    # print('common', common)
    ...
    for c in common:
        steps1 = wire1_pts[c]
        steps2 = wire2_pts[c]
        # print(c, steps1, steps2)
        mdist = min(mdist, steps1 + steps2)
...
def part1():
    ...
    for ins in wire2.split(','):
        ...
        for _ in range(m):
            row = row + DIRS[d][0]
            col = col + DIRS[d][1]
            wire2_pts.add((row, col))

    # print(wire1_pts)
    # print(wire2_pts)
    common = wire1_pts.intersection(wire2_pts)
    # print('common', common)
