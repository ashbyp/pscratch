pdata = """fdaebc egc gc bgefc ecbagd becfa fagc afgbec gdcbfae bgdef | cgfa gcebad ebcadfg cefgbad
...
tdata = """be cfbegad cbdgef fgaecd cgeb fdcge agebfd fecdb fabcd edb |fdgacbe cefdb cefbgd gcbe
...
def part1(data: str, debug: bool = False):
    ...
    print(counts)
    uniq = {2, 3, 4, 7}
    print(sum(counts[x] for x in uniq))
