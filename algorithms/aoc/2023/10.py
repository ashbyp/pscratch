...
def is_valid_move(src, tar, direction):
    syms = {'|', '-', 'L', 'J', '7', 'F', 'S'}
    if tar not in syms: return False
    ...
    return direction in valid[src] and tar in syms
...
while True:
    ...
    if prev_direction != S and is_valid_move(grid[x][y], grid[cur[0] - 1][cur[1]], N):
        # print('N')
        cur[0] -= 1
        prev_direction = N
        moves += 1
    elif prev_direction != N and is_valid_move(grid[x][y], grid[cur[0] + 1][cur[1]], S):
        # print('S')
        cur[0] += 1
        prev_direction = S
        moves += 1
    elif prev_direction != W and is_valid_move(grid[x][y], grid[cur[0]][cur[1] + 1], E):
        # print('E')
        cur[1] += 1
        prev_direction = E
        moves += 1
    # east
    elif prev_direction != E and is_valid_move(grid[x][y], grid[cur[0]][cur[1] - 1], W):
        # print('W')
        cur[1] -= 1
        prev_direction = W
        moves += 1
